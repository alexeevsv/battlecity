...
Player.prototype.figureNextWeapon = function () {
...
Player.prototype.checkAmmo = function () {
...
Player.prototype.addPing = function (value) {
...
Player.prototype.getAvgPing = function () {
...
Player.prototype.applyBonus = function (bonusName) {
    var crateBonus;
    ...
    switch (bonusName) {
        ...
        case Enum.bonuses.crate.title:
            ...
            switch (crateBonus) {
                case Enum.crateBonuses.cannon.title:
                case Enum.crateBonuses.mine.title:
                case Enum.crateBonuses.rocketLauncher.title:
                ...
                case Enum.crateBonuses.invincibility.title:
                    this.setInvincible();
                    break;
                case Enum.crateBonuses.invisibility.title:
                    this.setInvisible();
                    break;
            }
            break;
...
Player.prototype.setInvisible = function () {
    var self = this;

    self.visible = false;
    clearTimeout(self.invisibleTimeout);
    self.invisibleTimeout = setTimeout(function () {
        self.visible = true;
    }, 20000)
}

Player.prototype.setInvincible = function () {
    var self = this;
...
Player.prototype.getBonusFromCrate = function () {
    ...
    if (this.invincible === false) {
        ...
        if (tempArmor < 0) {
            ...
            if (this.hitPoints <= 0) {
                this.alive = false;
                this.hitPoints = 0;
                console.log("player_" + this.playerName + " died");
            }
        } else {
...
Player.prototype.reload = function (position) {
    this.alive = true;
    this.armor = Enum.playerArmor;
    this.hitPoints = Enum.playerHp;
    this.currentWeapon = Enum.weapons.cannon;
